...
- Resources and funding determine scale and persistence of attacks
...
| Insider Threat | Internal. Uses institutional knowledge to target vulnerable systems. Motivated by revenge or financial gain. Has legitimate access, making detection the hardest of any actor type. |
| Organized Crime | Mostly external. Motivated entirely by money. Sophisticated division of labor: hacker, exploit manager, data seller, customer service. Well-funded operations. |
...
- Service disruption: DoS/DDoS, competitive advantage, or smokescreen for another attack
